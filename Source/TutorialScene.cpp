...
TutorialScene::TutorialScene()
	: Scene() 
{
	// ?? mpCowManager = new CowManager() ????N???X Scene::Scene() ??
	// ????C???X?^???X??????????????A????????????i?|?C???^???????ˆè???????[?N?j??s???????B
	CowDelete = false;
	mfeverstate = FEVER_1; 
	timerCount = 0;        
}
...
TutorialScene::~TutorialScene()
{
	...
	// ?? mpCowManager ????N???X Scene ??f?X?g???N?^???????????????A
	// ???????˜@?????s???????B
}
...
// 2. ?z??????F?}?E?X???N???b?N?i?r?[?????j???s???????X?e?b?v??i??
...
// 3. ?R???{?X?R?A????F?v???C???[??2?A??????????????A?R???{??????????????X?e?b?v??
...
// 4. ?t?F?[?Y???o????F??ŠÎ??(3?b)???????????????Šß???I????X?e?b?v??
...
// ?I???X?e?b?v?F?`???[?g???A??????????e?L?X?g??\?????AENTER?L?[??????^?C?g??????
void TutorialScene::UpdateStateEnd()
{
	DrawTutorialText("?`???[?g???A???I???I ENTER?L?[???????^?C?g?????????B");
