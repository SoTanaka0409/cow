 ...
 * [入力] なぁE
 * [出力] なぁE
 * [副作用] Zソート用カメラ距離の更新、コライダーの一括処琁E��衁E
 */
void ObjectManager::Update()
{
	...
	// 半透�E描画時�EZソートで忁E��となるため、カメラとの距離を算�Eする
	for (auto obj : object3d_list_)
	{
	...
	// 座標更新が�Eて完亁E��た後に衝突判定を行うためここで一括処琁E��めE
 ...
 * [入力] なぁE
 * [出力] なぁE
 * [副作用] 描画フラグが有効なオブジェクトとコライダーの描画命令発衁E
 */
...
/*
 * @brief 3Dオブジェクトをリストから削除する�E�メモリ解放はしなぁE��E
...
/*
 * @brief 全ての3Dオブジェクトに削除フラグを立て、実際の削除処琁E��呼ぶ
 * [入力] なぁE
 * [出力] なぁE
 ...
 * [入力] tag: 検索対象のタグ
 * [出力] 条件に合�Eする最初�EObject3Dポインタ�E�見つからなぁE��合�Enullptr�E�E
 * [副作用] なぁE
 */
 ...
 * [入力] tag: 検索対象のタグ
 * [出力] 条件に合�Eする最初�EObject2Dポインタ�E�見つからなぁE��合�Enullptr�E�E
 * [副作用] なぁE
 */
