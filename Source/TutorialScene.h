...
public:
	...
	// [入力] なぁE[出力] なぁE[副作用] チE��スチャアセチE��読込、オブジェクト�E置、BGM再生
	void Initialize() override;

	// [入力] なぁE[出力] なぁE[副作用] スチE�Eトに基づく操作判定とフェード更新
	void Update() override;

	// [入力] なぁE[出力] なぁE[副作用] 画面にチE��ストと3D空間を描画
	void Draw() override;

	// [入力] なぁE[出力] なぁE[副作用] BGM停止など終亁E�E琁E
...
private:
	// [入力] なぁE[出力] なぁE[副作用] 墁E��用オブジェクトを配置
	void CreateFences();

	// [入力] なぁE[出力] なぁE[副作用] 領域外判定用の透�E壁を生�E
	void CreateWalls();
	...
	// [入力] text:表示斁E��E yOffset:Y座標オフセチE�� [出力] なぁE[副作用] 案�EチE��スト�E描画
